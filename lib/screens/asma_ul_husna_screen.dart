...
/// Displays the 99 Names of Allah with lazy loading
...
class _AsmaUlHusnaScreenState extends State<AsmaUlHusnaScreen> {
  ...
  Future<void> _loadNames() async {
    try {
      final names = await _apiService.getAllahNamesPaginated(
        page: 0,
        pageSize: _pageSize,
      );
      if (mounted) {
  ...
  Future<void> _loadMoreNames() async {
    ...
    try {
      ...
      final newNames = await _apiService.getAllahNamesPaginated(
        page: nextPage,
        pageSize: _pageSize,
      );
